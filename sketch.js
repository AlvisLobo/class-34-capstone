...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   rope2 = new Rope(7,{x:490,y:90});
    ...
    star1 = createSprite(350,75,10,10); 
    star1.scale = 0.03;  
    star1.addImage(star1Img); 

    star2 = createSprite(90,300,10,10); 
    star2.scale = 0.03; 
    star2.addImage(star2Img); 
    

   starDisplay = createSprite(50,30,20,10); 
   starDisplay.addAnimation("emptyStar", emptyStarImg); 
   starDisplay.addAnimation("oneStar" , oneStarImg); 
   starDisplay.addAnimation("twoStar" , twoStarImg); 
   starDisplay.changeAnimation("emptyStarImg")
